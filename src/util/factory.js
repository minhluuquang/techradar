...
function plotLogo(content) {
  content
    ...
    .html(
      '<a href="https://www.dwarves.foundation"><img src="/images/logo.png" / ></a>'
    );
}
...
function plotForm(content) {
  content
    ...
    .append("p")
    .html(
      '<strong>Enter the URL of your <a href="https://www.dwarves.foundation/radar/how-to-byor" target="_blank">Google Sheet or CSV</a> file below…</strong>'
    );
  ...
  form
    .append("p")
    .html(
      "<a href='https://www.dwarves.foundation/radar/how-to-byor'>Need help?</a>"
    );
}
...
function plotErrorMessage(exception) {
  ...
  var faqMessage =
    'Please check <a href="https://www.dwarves.foundation/radar/how-to-byor">FAQs</a> for possible solutions.';
